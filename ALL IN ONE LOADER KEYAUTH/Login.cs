...
namespace KeyAuth
{
    public partial class Login : Form
    {
        ...
        */
        ...
        static string name = "Gen"; // application name. right above the blurred text aka the secret on the licenses tab among other tabs
        static string ownerid = "MuBjo7OpPs"; // ownerid, found in account settings. click your profile picture on top right of dashboard and then account settings.
        static string secret = "e2bf92307c409c24ce110e17a5eb2df0fcc1c1bee35d259e5a79500fa3d78607"; // app secret, the blurred text on licenses tab and other tabs
